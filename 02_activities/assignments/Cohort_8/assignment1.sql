...
CASE 
WHEN product_size = 'unit' THEN 'unit'
ELSE "bulk"
...
SUM (cp.quantity*cp.cost_to_customer_per_qty) AS purchase_amount
...
CREATE TEMPORARY TABLE new_vendor (
	...
	vendor_owner_first_name VARCHAR(255), 
	vendor_owner_last_name VARCHAR(255)
);
